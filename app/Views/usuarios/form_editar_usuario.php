                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mb-12">
                                        <input type="text" id="login" maxlength="100" readonly
                                            ...
                                            autofocus name="login" value="<?= $login ?>"/>
                                    ...
                                    <div class="input-group mb-12 bordered-container">
                                        <div style="max-height: 200px; overflow-y: auto;">
                                            ...
                                            foreach ($selectPerfil as $key => $perfil) {
                                                ...
                                                foreach ($selectPerfisUsuario as $item) {
                                                    if ($perfil['id'] === $item['idperfil']) {
                                                        $checked = 'checked';
                                                        break;
                                                    }
                                                }
                                
                                                echo '<div class="form-check"><input class="form-check-input" type="checkbox" id="perfil'.$key.'" name="perfil[]" value="'.$perfilenconded.'" '.$checked.'><label class="form-check-label" for="perfil'.$key.'">'.$perfil['nmperfil'].'</label></div>';
                                            }
                                            ?>
