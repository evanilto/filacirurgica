    <form id="idForm" method="post" action="<?= base_url('prontuarios/historico') ?>">
        <?= csrf_field() ?>
        ...
        <div class="card">
            ...
            <div class="card-header text-black"  style="flex: 1; display: flex; justify-content: center; align-items: center;">
                <b><?= 'Consultar Histórico de Movimentações' ?></b>
            </div>
            ...
            <div class="col-md-12">
                <div class="card-body text-center">
                    <div class="row">
                        <div class="col-md-6">
                            <button class="btn btn-info mt-0" id="submit" name="submit"  type="submit" value="1"><i class="fa-solid fa-search"></i> Consultar</button>
                        </div>
                        <div class="col-md-6">
