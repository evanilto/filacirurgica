<table class="table table-hover table-bordered table-smaller-font table-striped" id="table">
    <thead>
        <tr>
            <th scope="col" colspan="10" class="bg-light text-center"><h5><strong>Solicitações do Setor</strong></h5></th>
        </tr>
        <tr>
            <th scope="col" class="col-1" data-field="Id" >No. Prontuário</th>
            <th scope="col" data-field="numvolume" >Vol.</th>
            <th scope="col" data-field="paciente" >Paciente</th>
            <th scope="col" data-field="setoratual" >Setor Atual</th>
    ...
    <tbody>
        ...
        <?php foreach($solicitacoes as $solicitacao): ?>
            <tr>
                ...
                <td><?php echo $solicitacao['setoratual'] ?></td>
