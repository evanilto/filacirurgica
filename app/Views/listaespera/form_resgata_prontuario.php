    <form id="tramitaForm" method="post" action="<?= base_url('prontuarios/resgatar') ?>">
        <?= csrf_field() ?>
        ...
        <div class="card">
            ...
            <div class="col-md-12">
                <div class="card-body text-center">
                    <div class="row">
                        <div class="col-md-6">
                            <button class="btn btn-info mt-0" id="submit" name="submit"  type="submit" value="1"><i class="fas fa-download"></i> Resgatar</button>
                        </div>
                        <div class="col-md-6">
