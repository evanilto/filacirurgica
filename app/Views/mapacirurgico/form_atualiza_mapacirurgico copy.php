...
<?php
    ...
    if (!empty($data['somenteCentroSala']) && $data['somenteCentroSala']) {
        ...
        $readonlyCamposGerais = $readonlyGeral;
        $readonlyCentroSala = $readonlyGeral;
    }

    //dd($readonlyCamposGerais, $readonlyCentroSala);
?>
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="dtcirurgia" maxlength="10" placeholder="DD/MM/AAAA"
                                            ...
                                            name="dtcirurgia" value="<?= set_value('dtcirurgia', $data['dtcirurgia']) ?>" <?= $readonlyCamposGerais ?>/>
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="input-group">
                                        <input type="time" id="hrcirurgia" maxlength="5" placeholder="HH:MM"
                                            ...
                                            name="hrcirurgia" value="<?= set_value('hrcirurgia', $data['hrcirurgia']) ?>" <?= $readonlyCamposGerais ?>/>
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="input-group">
                                        <input type="time" id="tempoprevisto" maxlength="5" placeholder="HH:MM"
                                            ...
                                            name="tempoprevisto" value="<?= set_value('tempoprevisto', $data['tempoprevisto']) ?>" <?= $readonlyCamposGerais ?>/>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select select2-dropdown  <?= $validation->hasError('centrocirurgico') ? 'is-invalid' : '' ?>" <?= $readonlyCentroSala ?>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <label for="sala" class="form-label">Salas<b class="text-danger">*</b></label>
                                                <select class="form-select select2-dropdown <?= $validation->hasError('sala') ? 'is-invalid' : '' ?>" <?= $readonlyCentroSala ?>
