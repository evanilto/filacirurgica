        ...
        <div class="col-md-10">
            <div class="card form-container">
                <div class="card-header text-center text-black">
                    <b><?= 'Registrar Quantidade Utilizada' ?></b>
                </div>
                <div class="card-body has-validation">
                    <form id="formUtilizacao" method="post" action="<?= base_url('mapacirurgico/salvarquantidadeutilizada') ?>">
                                            ...
                                            <div style="width: 30%;" class="text-center">
                                                <?php if (!empty($item['inddisponibilidade'])): ?>
                                                    <input type="number"
                                                        ...
                                                        min="0" required>
                                                <?php else: ?>
                                                    <input type="number" class="form-control" placeholder="Não reservado" disabled>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
                        ...
                        <div class="mt-4">
                            <button class="btn btn-success">
                                <i class="fa-solid fa-save"></i> Registrar Utilização
                            </button>
                            <a class="btn btn-secondary" href="<?= base_url('mapacirurgico/exibircirurgiacomhemocomps') ?>">
