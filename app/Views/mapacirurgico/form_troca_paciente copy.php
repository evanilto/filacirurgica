            ...
            <div class="card form-container">
                ...
                <div class="card-body has-validation">
                    <form id="idForm" method="post" action="<?= base_url('mapacirurgico/trocar') ?>">
                        ...
                        <input type="hidden" name="fila_hidden" name="fila_hidden" />
...
function verPacienteNaLista(event) {
    ...
    */
        $('#candidato').on('change', function() {
            ...
            var ifFilaValue = $(this).find('option:selected').data('idfila');
            ...
            $('select[name="fila"]').val(idFilaValue).change(); // Define o valor do hidden
            alert($('select[name="fila"]').val());

            $('select[name="procedimento"]').val(prodecimentoValue).change(); // Define o valor do hidden
            $('select[name="risco"]').val(riscoValue).change(); // Define o valor do hidden
