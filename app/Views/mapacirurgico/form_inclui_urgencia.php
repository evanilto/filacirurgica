                ...
                <div class="card-body has-validation">
                    <form id="idForm" method="post" action="<?= base_url('mapacirurgico/incluir') ?>">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="listaespera" class="form-label">Lista de Espera do Paciente</label>
                                    <select class="form-select select2-dropdown <?php if($validation->getError('listaespera')): ?>is-invalid<?php endif ?>"
                                        id="listaespera" name="listaespera"
                                        data-placeholder="" data-allow-clear="1">
                                        <option value="" <?php echo set_select('listaespera', '', TRUE); ?> ></option>
                                    </select>
                                    <?php if ($validation->getError('listaespera')): ?>
                                        <div class="invalid-feedback">
                                            <?= $validation->getError('listaespera') ?>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <textarea id="justurgencia" maxlength="255" rows="2"
            ...
            if (prontuario) {
                $.ajax({
                    ...
                    success: function(data) {
                        var $select = $('#listaespera');
                        $select.empty(); // Limpar o select
                       ...
                       /*  $.each(data, function(index, item) {
                            $select.append('<option value="' + item.id + '" data-fila="' + item.idtipoprocedimento + '" data-especialidade="' + item.idespecialidade + '" data-procedimento="' + item.idprocedimento + '">Especialidade: ' + item.especialidade_descricao + ' - Fila: ' + item.fila + ' - Procedimento: ' + item.procedimento_descricao + '</option>');
                            //$select.append('<option value="aaa"></option>');
                        }); */
                        //$select.trigger('change'); // Atualize o Select2
                        //$select.select2();
                    },
                    error: function(xhr, status, error) {
