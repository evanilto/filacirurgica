        ...
        <div class="col-md-8">
            <div class="card form-container">
                <div class="card-header text-center text-black">
                    <b><?= 'Consultar Justificativas' ?></b>
                </div>
                <div class="card-body has-validation">
                    <form id="idForm" method="post" action="<?= base_url('relatorios/exibirjustificativas') ?>">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="mb-2">
                                    <label for="dtinicio" class="form-label">Data Início Evento</label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-2">
                                    <label for="dtfim" class="form-label">Data Final Evento</label>
                                    <div class="input-group">
                        ...
                        <div class="row g-3"> 
                            <div class="col-md-6">
                                <div class="mb-2">
                                    <label for="tipojustificativa" class="form-label">Tipo de Justificativa<b class="text-danger">*</b></label>
                                    <div class="input-group">
                                        <select class="form-select select2-dropdown" id="tipojustificativa" name="tipojustificativa">
                                            <?php foreach ($data['tiposJustificativa'] as $key => $label): ?>
                                                <option value="<?= $key ?>" <?= set_select('tipojustificativa', $key); ?>>
                                                    <?= $label ?>
                                                </option>
                                            <?php endforeach; ?>
                                        </select>

                                        <?php if ($validation->getError('tipojustificativa')): ?>
                                            <div class="invalid-feedback">
                                                <?= $validation->getError('tipojustificativa') ?>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                </div>
