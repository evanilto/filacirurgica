            ...
            <div class="card form-container">
                ...
                <div class="card-body has-validation">
                    <form id="idForm" method="post" action="">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                            <a class="btn btn-warning mt-3" href="<?= $data['linkorigem'] === 'situacao_cirurgica' ? base_url('listaespera/exibirsituacao') : base_url('mapacirurgico/exibircirurgiasemaprovacao') ?>">
